...
def main():
    ...
    threads = [threading.Thread(target=func, args=[transmit_settings.return_transmit_settings('transmit_parameters'),lpwa_interface]) for func in transmit_settings.number_of_transmitters]
